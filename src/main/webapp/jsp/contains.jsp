...
if (!theCategory2.equals("")) {
			...
			categorySelect2 = (String)(org.celiac.util.database.DBQueryFactory.getDBHandler().getCategoryListThatContainsGluten().toArray()[new Integer(theCategory2).intValue() - 1]);
      categSet = org.celiac.util.database.DBQueryFactory.getDBHandler().containGF(categorySelect2);
...
<td></td>
		<td WIDTH="500">
			...
			<form name="query_form1" action="contains.jsp" method="POST">
					...
					<tr><td colspan="1" nowrap class="headerHeb"><%=org.celiac.util.TemplateReader.getHebrewMapWord("CATEGORIA_GLUTEN")%></td></tr>
  ...
  <tr>
     ...
     <tr>
    <tr><td colspan="1" nowrap style="width: 100%" class="headerUnderLineHeb"><%=org.celiac.util.TemplateReader.getHebrewMapWord("LEFANECHA_WITH_GLUTEN")%></td></tr>
        ...
        <font face="Verdana, Arial, Helvetica, sans-serif">
          ...
          <select name="category2" class="textfieldHeb" onchange="processSelectionCategory2();">
          	...
          	java.util.Iterator<String> itr2 = null;
						itr2 = org.celiac.util.database.DBQueryFactory.getDBHandler().getCategoryListThatContainsGluten().iterator();
						String tmpCategory2 = "";
				...
				compName = (String)itr6.next();
				  ...
				  <% if (color) {
				  	...
				  	<TABLE name="mulProd" BORDER="0" nowrap width="100%" BORDERCOLOR="#d5e0e6" BGCOLOR="#f5f5e1"  CELLSPACING="3" CELLPADDING="3">
						...
						<TR><TH  colspan="1" nowrap class="headerUnderLine4"><%=org.celiac.util.TemplateReader.getHebrewMapWord("NO")%></TH>
				  <%}else {
				     color = true;
				     %>
